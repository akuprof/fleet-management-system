...
-- Drivers - Admins and managers can view all, drivers can view their own
CREATE POLICY "Admins and managers can manage all drivers" ON drivers
  FOR ALL USING (
    EXISTS (
...
-- Vehicles - Admins and managers can manage all
CREATE POLICY "Admins and managers can manage all vehicles" ON vehicles
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles up 
      JOIN roles r ON up.role_id = r.id 
...
-- Assignments - Admins and managers can manage
...
CREATE POLICY "Admins and managers can manage all trips" ON trips
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles up 
      JOIN roles r ON up.role_id = r.id 
...
-- Daily summaries - Role-based access
CREATE POLICY "Admins and managers can view all summaries" ON daily_summaries
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles up 
      JOIN roles r ON up.role_id = r.id 
...
CREATE POLICY "Drivers can view their own summaries" ON daily_summaries
  FOR SELECT USING (
    driver_id IN (
      SELECT d.id FROM drivers d
      JOIN user_profiles up ON up.username = d.phone
...
-- Payouts - Role-based access
CREATE POLICY "Admins and managers can manage all payouts" ON payouts
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles up 
      JOIN roles r ON up.role_id = r.id 
...
CREATE POLICY "Drivers can view their own payouts" ON payouts
  FOR SELECT USING (
    driver_id IN (
      SELECT d.id FROM drivers d
      JOIN user_profiles up ON up.username = d.phone
...
-- Incidents - Role-based access
CREATE POLICY "Admins and managers can manage all incidents" ON incidents
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM user_profiles up 
      JOIN roles r ON up.role_id = r.id 
...
CREATE POLICY "Drivers can view and report their own incidents" ON incidents
  FOR ALL USING (
    driver_id IN (
      SELECT d.id FROM drivers d
      JOIN user_profiles up ON up.username = d.phone
...
-- Other tables - Admin and manager access only
